      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input 
            ...
            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 text-gray-900"
        ...
        <div>
          ...
          <textarea 
            ...
            rows={3}
            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#F97316] focus:ring-2 focus:ring-[#F97316]/20 text-gray-900 resize-none"
            style={{ fontSize: '0.9rem' }} 
          />
        </div>
